...
async def full_update_subtask(
    ...
    logging.info(f"[SUBTASKS] Параметры запроса (пришло с фронта: "
        f"task_id={task_id}, "
