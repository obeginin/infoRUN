...
BEGIN
    SELECT 
        ...
        COUNT(CASE WHEN CompletionStatus = '���������' THEN 1 END) AS CompletedSubTasks,
        COUNT(CASE WHEN CompletionStatus = '� ��������' THEN 1 END) AS InProgressSubTasks,
        COUNT(CASE WHEN CompletionStatus IS NULL OR CompletionStatus = '�� ���������' THEN 1 END) AS NotStartedSubTasks,
