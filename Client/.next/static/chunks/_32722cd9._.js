...
"[project]/src/src/Processes/ProtectedRoute/ProtectedRoute.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const ProtectedRoute = (param)=>{
    ...
    const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$store$2f$userStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUserStore"])({
        "ProtectedRoute.useUserStore[user]": (state)=>state.user
    }["ProtectedRoute.useUserStore[user]"]);
...
_s(ProtectedRoute, "04tKO3E2aHWohsnQfyqfx6CgDKE=", false, function() {
    return [
...
//# sourceMappingURL=_32722cd9._.js.map