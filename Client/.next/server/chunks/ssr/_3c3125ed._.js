...
"[project]/src/src/Widgets/Admin/AdminChangeUser/AdminChangeUser.module.scss.module.css [app-ssr] (css module)": ((__turbopack_context__) => {
...
"[project]/src/src/Features/Admin/AdminChangeUser/DialogDelete/DialogDelete.module.scss.module.css [app-ssr] (css module)": ((__turbopack_context__) => {
...
"[project]/src/src/API/students.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class StudentsAPI {
    static async getStudents() {
        const response = await fetch(`${("TURBOPACK compile-time value", "https://info-run.ru")}/students/api`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json"
            }
    ...
    static async deleteStudent(token, id) {
        const response = await fetch(`${("TURBOPACK compile-time value", "https://info-run.ru")}/api/students/delete_student?id=${id}`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                Authorization: `Bearer ${token}`
    ...
    static async addNewUser(token, login, last_name, first_name, email, phone, sex, roleId, password) {
        const response = await fetch(`${("TURBOPACK compile-time value", "https://info-run.ru")}/api/students/new_student`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                Authorization: `Bearer ${token}`
    ...
    static async editUser(token, id, login, last_name, first_name, middle_name, email, phone, sex, birth_date, comment, roleId, password) {
        const response = await fetch(`${("TURBOPACK compile-time value", "https://info-run.ru")}/api/students/edit_student?id=${id}`, {
            method: "PATCH",
            headers: {
                "Content-Type": "application/json",
                Authorization: `Bearer ${token}`
...
"[project]/src/src/store/adminStore.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$API$2f$students$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/src/API/students.ts [app-ssr] (ecmascript)");
;
;
;
const useAdminStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        users: [],
        currentUser: null,
        loading: false,
        ...
        fetchUsers: async (token)=>{
            ...
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$API$2f$admin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].getUsers(token);
                set({
                    users: response,
                    loading: false,
        ...
        deleteUser: async (token, id)=>{
            ...
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$API$2f$students$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].deleteStudent(token, id);
                set((state)=>({
        ...
        changePassword: async (token, id, password)=>{
            ...
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$API$2f$admin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].ChangePassword(token, id, password);
                set({
                    loading: false,
                    isVisibleDialogPassword: false,
        ...
        addNewUser: async (token, login, last_name, first_name, email, phone, sex, roleId, password)=>{
            ...
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$API$2f$students$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].addNewUser(token, login, last_name, first_name, email, phone, sex, roleId, password);
                set({
                    loading: false,
                    success: "User added"
                });
        ...
        editUser: async (token, id, login, last_name, first_name, middle_name, email, phone, sex, birth_date, comment, roleId, password)=>{
            ...
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$API$2f$students$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].editUser(token, id, login, last_name, first_name, middle_name, email, phone, sex, birth_date, comment, roleId, password);
                set({
                    loading: false,
                    success: "User edited",
                    isVisibleDialogEdit: false
...
"[project]/src/src/Features/Admin/AdminChangeUser/DialogDelete/DialogDelete.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$Features$2f$Admin$2f$AdminChangeUser$2f$DialogDelete$2f$DialogDelete$2e$module$2e$scss$2e$module$2e$css__$5b$app$2d$ssr$5d$__$28$css__module$29$__ = __turbopack_context__.i("[project]/src/src/Features/Admin/AdminChangeUser/DialogDelete/DialogDelete.module.scss.module.css [app-ssr] (css module)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$store$2f$adminStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/src/store/adminStore.ts [app-ssr] (ecmascript)");
...
const DialogDelete = ()=>{
    ...
    const { currentUser, deleteUser, isVisibleDialogDelete, setVisibleDialogDelete } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$store$2f$adminStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAdminStore"])();
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$ui$2f$IDialog$2f$IDialog$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["IDialog"], {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$Features$2f$Admin$2f$AdminChangeUser$2f$DialogDelete$2f$DialogDelete$2e$module$2e$scss$2e$module$2e$css__$5b$app$2d$ssr$5d$__$28$css__module$29$__["default"].dialog,
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$Features$2f$Admin$2f$AdminChangeUser$2f$DialogDelete$2f$DialogDelete$2e$module$2e$scss$2e$module$2e$css__$5b$app$2d$ssr$5d$__$28$css__module$29$__["default"].dialog__btn,
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$ui$2f$buttonDeafault$2f$Button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                ...
                                color: "white",
                                filled: true,
                                onClick: ()=>deleteUser(token, currentUser?.ID),
                                children: "Удалить"
                            }, void 0, false, {
                                fileName: "[project]/src/src/Features/Admin/AdminChangeUser/DialogDelete/DialogDelete.tsx",
                                lineNumber: 31,
...
"[project]/src/src/Features/Admin/AdminChangeUser/DialogPassword/DialogPassword.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const DialogPassword = ()=>{
    const token = localStorage.getItem("token") || "";
    const { currentUser, changePassword, isVisibleDialogPassword, setVisibleDialogPassword } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$store$2f$adminStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAdminStore"])();
    ...
    const handleClick = ()=>{
        if (newPassword.length < 6) {
            ...
            changePassword(token, currentUser?.ID, newPassword);
        }
    };
...
"[project]/src/src/Features/Admin/AdminChangeUser/DialogEdit/DialogEdit.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
const DialogEdit = ()=>{
    const { isVisibleDialogEdit, setVisibleDialogEdit, editUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$store$2f$adminStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAdminStore"])();
    const currentUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$store$2f$adminStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAdminStore"])((state)=>state.currentUser);
    ...
    const handleClick = ()=>{
        editUser(localStorage.getItem("token") || "", currentUser?.ID, editedUser.login, editedUser.lastName, editedUser.firstName, editedUser.middleName, editedUser.email, editedUser.phone, editedUser.sex, editedUser.birthDate, editedUser.comment, editedUser.roleName, editedUser.password);
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$ui$2f$IDialog$2f$IDialog$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["IDialog"], {
...
"[project]/src/src/Widgets/Admin/AdminChangeUser/AdminChangeUser.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$Widgets$2f$Admin$2f$AdminChangeUser$2f$AdminChangeUser$2e$module$2e$scss$2e$module$2e$css__$5b$app$2d$ssr$5d$__$28$css__module$29$__ = __turbopack_context__.i("[project]/src/src/Widgets/Admin/AdminChangeUser/AdminChangeUser.module.scss.module.css [app-ssr] (css module)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$Features$2f$Admin$2f$AdminChangeUser$2f$DialogDelete$2f$DialogDelete$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/src/Features/Admin/AdminChangeUser/DialogDelete/DialogDelete.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$Features$2f$Admin$2f$AdminChangeUser$2f$DialogPassword$2f$DialogPassword$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/src/Features/Admin/AdminChangeUser/DialogPassword/DialogPassword.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$store$2f$adminStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/src/store/adminStore.ts [app-ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$Features$2f$Admin$2f$AdminChangeUser$2f$DialogEdit$2f$DialogEdit$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/src/Features/Admin/AdminChangeUser/DialogEdit/DialogEdit.tsx [app-ssr] (ecmascript)");
'use client';
;
;
;
...
;
;
const TableUsers = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["lazy"])(()=>__turbopack_context__.r("[project]/src/src/Features/Admin/AdminChangeUser/TableUsers/TableUsers.tsx [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i));
;
;
;
const AdminChangeUser = ()=>{
    ...
    const token = localStorage.getItem("token") || "";
    const { fetchUsers, searchQuery, setSearchQuery, error, success, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$store$2f$adminStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAdminStore"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        fetchUsers(token);
    }, [
        fetchUsers,
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$Features$2f$ProfileContentContainer$2f$ProfileContentContainer$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ProfileContentContainer"], {
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$Widgets$2f$Admin$2f$AdminChangeUser$2f$AdminChangeUser$2e$module$2e$scss$2e$module$2e$css__$5b$app$2d$ssr$5d$__$28$css__module$29$__["default"].user__item,
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Suspense"], {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(TableUsers, {}, void 0, false, {
                                    fileName: "[project]/src/src/Widgets/Admin/AdminChangeUser/AdminChangeUser.tsx",
                                    lineNumber: 72,
                                    columnNumber: 15
                                }, ("TURBOPACK compile-time value", void 0))
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$Features$2f$Admin$2f$AdminChangeUser$2f$DialogDelete$2f$DialogDelete$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DialogDelete"], {}, void 0, false, {
                fileName: "[project]/src/src/Widgets/Admin/AdminChangeUser/AdminChangeUser.tsx",
                lineNumber: 78,
                columnNumber: 7
            }, ("TURBOPACK compile-time value", void 0)),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$Features$2f$Admin$2f$AdminChangeUser$2f$DialogPassword$2f$DialogPassword$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DialogPassword"], {}, void 0, false, {
                fileName: "[project]/src/src/Widgets/Admin/AdminChangeUser/AdminChangeUser.tsx",
                lineNumber: 79,
                columnNumber: 7
            }, ("TURBOPACK compile-time value", void 0)),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$Features$2f$Admin$2f$AdminChangeUser$2f$DialogEdit$2f$DialogEdit$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DialogEdit"], {}, void 0, false, {
                fileName: "[project]/src/src/Widgets/Admin/AdminChangeUser/AdminChangeUser.tsx",
                lineNumber: 80,
                columnNumber: 7
            }, ("TURBOPACK compile-time value", void 0))
...
"[project]/src/src/Widgets/Admin/AdminNewUser/AdminNewUser.module.scss.module.css [app-ssr] (css module)": ((__turbopack_context__) => {
...
"[project]/src/src/Widgets/Admin/AdminNewUser/AdminNewUser.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$API$2f$admin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/src/API/admin.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$ui$2f$input$2f$Input$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/src/ui/input/Input.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$Widgets$2f$Admin$2f$AdminNewUser$2f$AdminNewUser$2e$module$2e$scss$2e$module$2e$css__$5b$app$2d$ssr$5d$__$28$css__module$29$__ = __turbopack_context__.i("[project]/src/src/Widgets/Admin/AdminNewUser/AdminNewUser.module.scss.module.css [app-ssr] (css module)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$store$2f$adminStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/src/store/adminStore.ts [app-ssr] (ecmascript)");
'use client';
;
;
...
const AdminNewUser = ()=>{
    ...
    const [sex, setSex] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("М");
    ...
    const [passwordError, setPasswordError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const addNewUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$store$2f$adminStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAdminStore"])((state)=>state.addNewUser);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$API$2f$admin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].adminRoles(token ? token : "").then((response)=>setData(response)).catch((error)=>console.log(error));
    }, [
        token
    ]);
    const handleClick = ()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$Features$2f$ProfileContentContainer$2f$ProfileContentContainer$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ProfileContentContainer"], {
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$Widgets$2f$Admin$2f$AdminNewUser$2f$AdminNewUser$2e$module$2e$scss$2e$module$2e$css__$5b$app$2d$ssr$5d$__$28$css__module$29$__["default"].form,
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$ui$2f$input$2f$Input$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Input"], {
                            radius: "16px",
                            value: user,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$Widgets$2f$Admin$2f$AdminNewUser$2f$AdminNewUser$2e$module$2e$scss$2e$module$2e$css__$5b$app$2d$ssr$5d$__$28$css__module$29$__["default"].select__container,
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("i", {
                                    className: `pi pi-chevron-down ${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$Widgets$2f$Admin$2f$AdminNewUser$2f$AdminNewUser$2e$module$2e$scss$2e$module$2e$css__$5b$app$2d$ssr$5d$__$28$css__module$29$__["default"].icon}`
                                }, void 0, false, {
                                    fileName: "[project]/src/src/Widgets/Admin/AdminNewUser/AdminNewUser.tsx",
                                    lineNumber: 140,
                                    columnNumber: 13
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                    className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$Widgets$2f$Admin$2f$AdminNewUser$2f$AdminNewUser$2e$module$2e$scss$2e$module$2e$css__$5b$app$2d$ssr$5d$__$28$css__module$29$__["default"].select,
                                    value: sex,
                                    onChange: (e)=>setSex(e.target.value),
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                            value: "М",
                                            className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$src$2f$Widgets$2f$Admin$2f$AdminNewUser$2f$AdminNewUser$2e$module$2e$scss$2e$module$2e$css__$5b$app$2d$ssr$5d$__$28$css__module$29$__["default"].option,
                                            children: "Мужской"
                                        }, void 0, false, {
                                            fileName: "[project]/src/src/Widgets/Admin/AdminNewUser/AdminNewUser.tsx",
                                            lineNumber: 146,
...
//# sourceMappingURL=_3c3125ed._.js.map