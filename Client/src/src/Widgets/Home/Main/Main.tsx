        ...
        <div className={styles.container} style={{ position: "relative" }}>
          <div className={styles.main}>
            <div className={styles.main__content}>
              <h1>
                Подготовка к <span className={styles.ege}>ЕГЭ</span> онлайн —
                уверенность в каждом ответе!
              </h1>
              {/* <h1>
                Онлайн-платформа для подготовки к <span className={styles.ege}>ЕГЭ</span> — ваш надежный помощник в
              ...
              <Paragraph>
                Присоединяйтесь к образовательной платформе, которая помогает
                школьникам и учителям достигать высоких результатов.
