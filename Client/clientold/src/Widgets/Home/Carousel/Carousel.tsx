...
export const Carousel = () => {
  ...
  // removed inline height control; using SCSS breakpoints instead
  ...
  // ensure CSS transform transition doesn't fight with GSAP
  ...
  // Using SCSS to control responsive heights; no inline height logic

  // Set initial position and animate in the first slide content
  useLayoutEffect(() => {
